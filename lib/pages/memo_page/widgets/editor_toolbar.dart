        ...
        child: Row(
          children: [
            Row(
              ...
              children: [
                IconButton(
                  icon: recordingState.isRecording ? SvgPicture.asset('assets/icons/Stop.svg') : SvgPicture.asset('assets/icons/Mic.svg'),
                  onPressed: () async {
            ...
            CompositedTransformTarget(
              link: _layerLink,
              child: IconButton(
                icon: SvgPicture.asset('assets/icons/Fontsize.svg'),
